...
const BarcodeModal = ({modalOpenFunction}) => {
    return (
        <div className="w-[20rem] px-3 py-2 rounded-[5px] shadow-sm bg-white border-2">
            ...
            <div className="w-[100%] flex">
                <button className="bg-[#118B50] px-3 py-1 flex text-[white] text-[0.7rem] mt-2 ml-auto items-center justify-center rounded-[3px]">
                    Find
                </button>
            </div>
        </div>
