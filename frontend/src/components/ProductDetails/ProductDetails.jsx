                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div className="grid w-[50%] grid-cols-[70%_30%] mt-1">
                                <div className="border-[1px] border-[#e0e0e0] px-2 py-1">Hello Hello Hello Hello Hello</div>
                                <div className="border-[1px] border-l-0 border-[#e0e0e0] px-2 py-1">Hello</div>
                                <div className="border-[1px] border-[#e0e0e0] border-t-0 px-2 py-1">Hello</div>
                                <div className="border-[1px] border-l-0 border-t-0 border-[#e0e0e0] px-2 py-1">Hello</div>
                            </div>
                        </div>
                    </div>
                </div>
